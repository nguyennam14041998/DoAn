    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.thanhvienHD.home.createOrEditLabel">
              <Translate contentKey="doAnApp.thanhvienHD.home.createOrEditLabel">Create or edit a ThanhvienHD</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : thanhvienHDEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="tenLabel" for="thanhvien-hd-ten">
                    <Translate contentKey="doAnApp.thanhvienHD.ten">Ten</Translate>
                  </Label>
                  <AvField id="thanhvien-hd-ten" type="text" name="ten" />
                </AvGroup>
                <AvGroup>
                  <Label id="donviLabel" for="thanhvien-hd-donvi">
                    <Translate contentKey="doAnApp.thanhvienHD.donvi">Donvi</Translate>
                  </Label>
                  <AvField id="thanhvien-hd-donvi" type="text" name="donvi" />
                </AvGroup>
                <AvGroup>
                  <Label id="trachnhiemLabel" for="thanhvien-hd-trachnhiem">
                    <Translate contentKey="doAnApp.thanhvienHD.trachnhiem">Trachnhiem</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="sudungLabel" for="thanhvien-hd-sudung">
                    <Translate contentKey="doAnApp.thanhvienHD.sudung">Sudung</Translate>
                  </Label>
                  <AvField id="thanhvien-hd-sudung" type="string" className="form-control" name="sudung" />
                </AvGroup>
                <AvGroup>
                  <Label for="thanhvien-hd-hoidongdanhgia">
                    <Translate contentKey="doAnApp.thanhvienHD.hoidongdanhgia">Hoidongdanhgia</Translate>
                  </Label>
