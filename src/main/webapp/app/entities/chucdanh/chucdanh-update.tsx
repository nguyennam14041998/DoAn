    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.chucdanh.home.createOrEditLabel">
              <Translate contentKey="doAnApp.chucdanh.home.createOrEditLabel">Create or edit a Chucdanh</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
