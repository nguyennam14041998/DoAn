    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.donvi.home.createOrEditLabel">
              <Translate contentKey="doAnApp.donvi.home.createOrEditLabel">Create or edit a Donvi</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
