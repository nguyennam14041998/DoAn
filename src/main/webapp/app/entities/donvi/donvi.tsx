            ...
            <div className="filter-quanlydulieu">
              <div className="row">
                <div className="col-3">
                  ...
                  <input type="text" name="filterMa" value={this.state.filterMa} onChange={this.onChange} className="form-control" placeholder="Mã chuyên ngành" />
                </div>
                <div className="col-3">

                  <input type="text" name="filterTen" value={this.state.filterTen} onChange={this.onChange} className="form-control" placeholder="Tên chuyên ngành" />
                </div>
                <div className="col-2">
                            ...
                            {close =>
                              <table className="table-hover table-button-active">
                                ...
                                <tbody>
                                  ...
                                  <tr onClick={close}>
                                    <td ><button onClick={()=>this.delete(donvi)} className=" btn-sua" >Xóa </button></td>
                                  </tr>
