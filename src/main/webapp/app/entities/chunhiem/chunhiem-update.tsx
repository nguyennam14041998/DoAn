    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.chunhiem.home.createOrEditLabel">
              <Translate contentKey="doAnApp.chunhiem.home.createOrEditLabel">Create or edit a Chunhiem</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : chunhiemEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="sudungLabel" for="chunhiem-sudung">
                    <Translate contentKey="doAnApp.chunhiem.sudung">Sudung</Translate>
                  </Label>
                  <AvField id="chunhiem-sudung" type="string" className="form-control" name="sudung" />
                </AvGroup>
                <AvGroup>
                  <Label for="chunhiem-nhansu">
                    <Translate contentKey="doAnApp.chunhiem.nhansu">Nhansu</Translate>
                  </Label>
