...
import { getEntity, deleteEntity } from './chunhiem.reducer';
...
export class ChunhiemDeleteDialog extends React.Component<IChunhiemDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.chunhiemEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="doAnApp.chunhiem.delete.question">
          <Translate contentKey="doAnApp.chunhiem.delete.question" interpolate={{ id: chunhiemEntity.id }}>
