    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.danhgia.home.createOrEditLabel">
              <Translate contentKey="doAnApp.danhgia.home.createOrEditLabel">Create or edit a Danhgia</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : danhgiaEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="maLabel" for="danhgia-ma">
                    <Translate contentKey="doAnApp.danhgia.ma">Ma</Translate>
                  </Label>
                  <AvField id="danhgia-ma" type="text" name="ma" />
                </AvGroup>
                <AvGroup>
                  <Label id="tenLabel" for="danhgia-ten">
                    <Translate contentKey="doAnApp.danhgia.ten">Ten</Translate>
                  </Label>
                  <AvField id="danhgia-ten" type="text" name="ten" />
                </AvGroup>
                <AvGroup>
                  <Label id="diemLabel" for="danhgia-diem">
                    <Translate contentKey="doAnApp.danhgia.diem">Diem</Translate>
                  </Label>
                  <AvField id="danhgia-diem" type="string" className="form-control" name="diem" />
                </AvGroup>
                <AvGroup>
                  <Label id="noidungLabel" for="danhgia-noidung">
                    <Translate contentKey="doAnApp.danhgia.noidung">Noidung</Translate>
                  </Label>
                  <AvField id="danhgia-noidung" type="text" name="noidung" />
                </AvGroup>
                <AvGroup>
                  <Label id="sudungLabel" for="danhgia-sudung">
                    <Translate contentKey="doAnApp.danhgia.sudung">Sudung</Translate>
                  </Label>
                  <AvField id="danhgia-sudung" type="string" className="form-control" name="sudung" />
                </AvGroup>
                <AvGroup>
                  <Label for="danhgia-detai">
                    <Translate contentKey="doAnApp.danhgia.detai">Detai</Translate>
                  </Label>
                  <AvInput id="danhgia-detai" type="select" className="form-control" name="detaiId">
                    <option value="" key="0" />
                    {detais
