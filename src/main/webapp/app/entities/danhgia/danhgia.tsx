    ...
    return (
      <div>
        <h2 id="danhgia-heading">
          <Translate contentKey="doAnApp.danhgia.home.title">Danhgias</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="doAnApp.danhgia.home.createLabel">Create a new Danhgia</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {danhgiaList && danhgiaList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('ma')}>
                    <Translate contentKey="doAnApp.danhgia.ma">Ma</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('ten')}>
                    <Translate contentKey="doAnApp.danhgia.ten">Ten</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('diem')}>
                    <Translate contentKey="doAnApp.danhgia.diem">Diem</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('noidung')}>
                    <Translate contentKey="doAnApp.danhgia.noidung">Noidung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('sudung')}>
                    <Translate contentKey="doAnApp.danhgia.sudung">Sudung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="doAnApp.danhgia.detai">Detai</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {danhgiaList.map((danhgia, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{danhgia.detaiId ? <Link to={`detai/${danhgia.detaiId}`}>{danhgia.detaiId}</Link> : ''}</td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="doAnApp.danhgia.home.notFound">No Danhgias found</Translate>
            </div>
          )}
        </div>
