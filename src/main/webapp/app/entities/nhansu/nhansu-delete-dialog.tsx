...
import { getEntity, deleteEntity } from './nhansu.reducer';
...
export class NhansuDeleteDialog extends React.Component<INhansuDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.nhansuEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="doAnApp.nhansu.delete.question">
          <Translate contentKey="doAnApp.nhansu.delete.question" interpolate={{ id: nhansuEntity.id }}>
