...
import { getEntity, deleteEntity } from './linhvuc.reducer';
...
export class LinhvucDeleteDialog extends React.Component<ILinhvucDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.linhvucEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="doAnApp.linhvuc.delete.question">
          <Translate contentKey="doAnApp.linhvuc.delete.question" interpolate={{ id: linhvucEntity.id }}>
            Are you sure you want to delete this Linhvuc?
          </Translate>
        </ModalBody>
        <ModalFooter>
