    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.linhvuc.home.createOrEditLabel">
              <Translate contentKey="doAnApp.linhvuc.home.createOrEditLabel">Create or edit a Linhvuc</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : linhvucEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="malvLabel" for="linhvuc-malv">
                    <Translate contentKey="doAnApp.linhvuc.malv">Malv</Translate>
                  </Label>
                  <AvField id="linhvuc-malv" type="text" name="malv" />
                </AvGroup>
                <AvGroup>
                  <Label id="tenlvLabel" for="linhvuc-tenlv">
                    <Translate contentKey="doAnApp.linhvuc.tenlv">Tenlv</Translate>
                  </Label>
                  <AvField id="linhvuc-tenlv" type="text" name="tenlv" />
                </AvGroup>
                <AvGroup>
                  <Label id="sudungLabel" for="linhvuc-sudung">
                    <Translate contentKey="doAnApp.linhvuc.sudung">Sudung</Translate>
                  </Label>
