  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="doAnApp.coquanphoihop.detail.title">Coquanphoihop</Translate> [<b>{coquanphoihopEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>
              {coquanphoihopEntity.detais
                ? coquanphoihopEntity.detais.map((val, i) => (
                    <span key={val.id}>
                      <a>{val.id}</a>
                      {i === coquanphoihopEntity.detais.length - 1 ? '' : ', '}
                    </span>
                  ))
                : null}
            </dd>
