    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.hoidongdanhgia.home.createOrEditLabel">
              <Translate contentKey="doAnApp.hoidongdanhgia.home.createOrEditLabel">Create or edit a Hoidongdanhgia</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
