...
import { getEntity, deleteEntity } from './hoidongdanhgia.reducer';
...
export class HoidongdanhgiaDeleteDialog extends React.Component<IHoidongdanhgiaDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.hoidongdanhgiaEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="doAnApp.hoidongdanhgia.delete.question">
          <Translate contentKey="doAnApp.hoidongdanhgia.delete.question" interpolate={{ id: hoidongdanhgiaEntity.id }}>
