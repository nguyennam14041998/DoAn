    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.tiendo.home.createOrEditLabel">
              <Translate contentKey="doAnApp.tiendo.home.createOrEditLabel">Create or edit a Tiendo</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : tiendoEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="thoigianketthucLabel" for="tiendo-thoigianketthuc">
                    <Translate contentKey="doAnApp.tiendo.thoigianketthuc">Thoigianketthuc</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="khoiluonghoanthanhLabel" for="tiendo-khoiluonghoanthanh">
                    <Translate contentKey="doAnApp.tiendo.khoiluonghoanthanh">Khoiluonghoanthanh</Translate>
                  </Label>
