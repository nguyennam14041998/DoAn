...
import { getEntity, deleteEntity } from './hocham.reducer';
...
export class HochamDeleteDialog extends React.Component<IHochamDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.hochamEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="doAnApp.hocham.delete.question">
          <Translate contentKey="doAnApp.hocham.delete.question" interpolate={{ id: hochamEntity.id }}>
