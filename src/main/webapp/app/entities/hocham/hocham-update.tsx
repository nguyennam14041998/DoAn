    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.hocham.home.createOrEditLabel">
              <Translate contentKey="doAnApp.hocham.home.createOrEditLabel">Create or edit a Hocham</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : hochamEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="mahochamLabel" for="hocham-mahocham">
                    <Translate contentKey="doAnApp.hocham.mahocham">Mahocham</Translate>
                  </Label>
                  <AvField id="hocham-mahocham" type="text" name="mahocham" />
                </AvGroup>
                <AvGroup>
                  <Label id="tenhochamLabel" for="hocham-tenhocham">
                    <Translate contentKey="doAnApp.hocham.tenhocham">Tenhocham</Translate>
                  </Label>
                  <AvField id="hocham-tenhocham" type="text" name="tenhocham" />
                </AvGroup>
                <AvGroup>
                  <Label id="sudungLabel" for="hocham-sudung">
                    <Translate contentKey="doAnApp.hocham.sudung">Sudung</Translate>
                  </Label>
