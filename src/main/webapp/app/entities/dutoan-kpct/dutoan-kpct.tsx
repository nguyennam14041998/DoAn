    ...
    return (
      <div>
        <h2 id="dutoan-kpct-heading">
          <Translate contentKey="doAnApp.dutoanKPCT.home.title">Dutoan KPCTS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="doAnApp.dutoanKPCT.home.createLabel">Create a new Dutoan KPCT</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {dutoanKPCTList && dutoanKPCTList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('soluong')}>
                    <Translate contentKey="doAnApp.dutoanKPCT.soluong">Soluong</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('mucchi')}>
                    <Translate contentKey="doAnApp.dutoanKPCT.mucchi">Mucchi</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tong')}>
                    <Translate contentKey="doAnApp.dutoanKPCT.tong">Tong</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('sudung')}>
                    <Translate contentKey="doAnApp.dutoanKPCT.sudung">Sudung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="doAnApp.dutoanKPCT.dutoanKP">Dutoan KP</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="doAnApp.dutoanKPCT.noidungDT">Noidung DT</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="doAnApp.dutoanKPCT.home.notFound">No Dutoan KPCTS found</Translate>
            </div>
          )}
        </div>
