    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.dutoanKPCT.home.createOrEditLabel">
              <Translate contentKey="doAnApp.dutoanKPCT.home.createOrEditLabel">Create or edit a DutoanKPCT</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : dutoanKPCTEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="soluongLabel" for="dutoan-kpct-soluong">
                    <Translate contentKey="doAnApp.dutoanKPCT.soluong">Soluong</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="dutoan-kpct-noidungDT">
                    <Translate contentKey="doAnApp.dutoanKPCT.noidungDT">Noidung DT</Translate>
                  </Label>
