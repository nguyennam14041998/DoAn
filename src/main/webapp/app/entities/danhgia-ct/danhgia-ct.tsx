    ...
    return (
      <div>
        <h2 id="danhgia-ct-heading">
          <Translate contentKey="doAnApp.danhgiaCT.home.title">Danhgia CTS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="doAnApp.danhgiaCT.home.createLabel">Create a new Danhgia CT</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {danhgiaCTList && danhgiaCTList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('diem')}>
                    <Translate contentKey="doAnApp.danhgiaCT.diem">Diem</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('sudung')}>
                    <Translate contentKey="doAnApp.danhgiaCT.sudung">Sudung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="doAnApp.danhgiaCT.danhgia">Danhgia</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="doAnApp.danhgiaCT.home.notFound">No Danhgia CTS found</Translate>
            </div>
          )}
        </div>
