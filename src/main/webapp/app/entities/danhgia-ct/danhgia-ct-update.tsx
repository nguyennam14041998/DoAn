...
export class DanhgiaCTUpdate extends React.Component<IDanhgiaCTUpdateProps, IDanhgiaCTUpdateState> {
  ...
  render() {
    const { danhgiaCTEntity, danhgias, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.danhgiaCT.home.createOrEditLabel">
              <Translate contentKey="doAnApp.danhgiaCT.home.createOrEditLabel">Create or edit a DanhgiaCT</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
