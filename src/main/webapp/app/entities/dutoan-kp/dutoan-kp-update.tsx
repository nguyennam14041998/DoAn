    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.dutoanKP.home.createOrEditLabel">
              <Translate contentKey="doAnApp.dutoanKP.home.createOrEditLabel">Create or edit a DutoanKP</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : dutoanKPEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="madutoanLabel" for="dutoan-kp-madutoan">
                    <Translate contentKey="doAnApp.dutoanKP.madutoan">Madutoan</Translate>
                  </Label>
                  <AvField id="dutoan-kp-madutoan" type="text" name="madutoan" />
                </AvGroup>
                <AvGroup>
                  <Label id="tendutoanLabel" for="dutoan-kp-tendutoan">
                    <Translate contentKey="doAnApp.dutoanKP.tendutoan">Tendutoan</Translate>
                  </Label>
                  <AvField id="dutoan-kp-tendutoan" type="text" name="tendutoan" />
                </AvGroup>
                <AvGroup>
                  <Label id="noidungLabel" for="dutoan-kp-noidung">
                    <Translate contentKey="doAnApp.dutoanKP.noidung">Noidung</Translate>
                  </Label>
                  <AvField id="dutoan-kp-noidung" type="text" name="noidung" />
                </AvGroup>
                <AvGroup>
                  <Label id="sudungLabel" for="dutoan-kp-sudung">
                    <Translate contentKey="doAnApp.dutoanKP.sudung">Sudung</Translate>
                  </Label>
                  <AvField id="dutoan-kp-sudung" type="string" className="form-control" name="sudung" />
                </AvGroup>
                <AvGroup>
                  <Label for="dutoan-kp-detai">
                    <Translate contentKey="doAnApp.dutoanKP.detai">Detai</Translate>
                  </Label>
                  <AvInput id="dutoan-kp-detai" type="select" className="form-control" name="detaiId">
                    <option value="" key="0" />
                    {detais
