    ...
    return (
      <div>
        <h2 id="dutoan-kp-heading">
          <Translate contentKey="doAnApp.dutoanKP.home.title">Dutoan KPS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="doAnApp.dutoanKP.home.createLabel">Create a new Dutoan KP</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {dutoanKPList && dutoanKPList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('madutoan')}>
                    <Translate contentKey="doAnApp.dutoanKP.madutoan">Madutoan</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('tendutoan')}>
                    <Translate contentKey="doAnApp.dutoanKP.tendutoan">Tendutoan</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('noidung')}>
                    <Translate contentKey="doAnApp.dutoanKP.noidung">Noidung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('sudung')}>
                    <Translate contentKey="doAnApp.dutoanKP.sudung">Sudung</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="doAnApp.dutoanKP.detai">Detai</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {dutoanKPList.map((dutoanKP, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{dutoanKP.detaiId ? <Link to={`detai/${dutoanKP.detaiId}`}>{dutoanKP.detaiId}</Link> : ''}</td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="doAnApp.dutoanKP.home.notFound">No Dutoan KPS found</Translate>
            </div>
          )}
        </div>
