    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.noidungDT.home.createOrEditLabel">
              <Translate contentKey="doAnApp.noidungDT.home.createOrEditLabel">Create or edit a NoidungDT</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : noidungDTEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="tennoidungLabel" for="noidung-dt-tennoidung">
                    <Translate contentKey="doAnApp.noidungDT.tennoidung">Tennoidung</Translate>
                  </Label>
                  <AvField id="noidung-dt-tennoidung" type="text" name="tennoidung" />
                </AvGroup>
                <AvGroup>
                  <Label id="sudungLabel" for="noidung-dt-sudung">
                    <Translate contentKey="doAnApp.noidungDT.sudung">Sudung</Translate>
                  </Label>
