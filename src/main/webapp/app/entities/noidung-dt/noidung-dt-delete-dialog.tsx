...
import { getEntity, deleteEntity } from './noidung-dt.reducer';
...
export class NoidungDTDeleteDialog extends React.Component<INoidungDTDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.noidungDTEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="doAnApp.noidungDT.delete.question">
          <Translate contentKey="doAnApp.noidungDT.delete.question" interpolate={{ id: noidungDTEntity.id }}>
