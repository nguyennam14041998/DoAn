  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="doAnApp.noidungdanhgia.detail.title">Noidungdanhgia</Translate> [<b>{noidungdanhgiaEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{noidungdanhgiaEntity.danhgiaCTId ? noidungdanhgiaEntity.danhgiaCTId : ''}</dd>
          </dl>
