    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="doAnApp.capdetai.home.createOrEditLabel">
              <Translate contentKey="doAnApp.capdetai.home.createOrEditLabel">Create or edit a Capdetai</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
