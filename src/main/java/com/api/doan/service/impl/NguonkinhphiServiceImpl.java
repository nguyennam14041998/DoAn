...
public class NguonkinhphiServiceImpl implements NguonkinhphiService {
    ...
    /**
     * Get all the nguonkinhphis with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<NguonkinhphiDTO> findAllWithEagerRelationships(Pageable pageable) {
        return nguonkinhphiRepository.findAllWithEagerRelationships(pageable).map(nguonkinhphiMapper::toDto);
    }
    ...
    public Optional<NguonkinhphiDTO> findOne(Long id) {
        ...
        return nguonkinhphiRepository.findOneWithEagerRelationships(id)
            .map(nguonkinhphiMapper::toDto);
    }
