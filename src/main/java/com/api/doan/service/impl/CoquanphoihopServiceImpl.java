...
public class CoquanphoihopServiceImpl implements CoquanphoihopService {
     ...
     * @return the list of entities.
     */
    public Page<CoquanphoihopDTO> findAllWithEagerRelationships(Pageable pageable) {
        return coquanphoihopRepository.findAllWithEagerRelationships(pageable).map(coquanphoihopMapper::toDto);
    }
    ...
    public Optional<CoquanphoihopDTO> findOne(Long id) {
        ...
        return coquanphoihopRepository.findOneWithEagerRelationships(id)
            .map(coquanphoihopMapper::toDto);
    }
