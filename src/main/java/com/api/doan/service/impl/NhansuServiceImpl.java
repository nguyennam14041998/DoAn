...
public class NhansuServiceImpl implements NhansuService {
     ...
     * @return the list of entities.
     */
    public Page<NhansuDTO> findAllWithEagerRelationships(Pageable pageable) {
        return nhansuRepository.findAllWithEagerRelationships(pageable).map(nhansuMapper::toDto);
    }
    ...
    public Optional<NhansuDTO> findOne(Long id) {
        ...
        return nhansuRepository.findOneWithEagerRelationships(id)
            .map(nhansuMapper::toDto);
    }
