...
public class Nhansu implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "nhansu_detai",
               joinColumns = @JoinColumn(name = "nhansu_id", referencedColumnName = "id"),
    ...
    public Nhansu detais(Set<Detai> detais) {
        this.detais = detais;
        return this;
    }

    public Nhansu addDetai(Detai detai) {
        this.detais.add(detai);
        detai.getNhansus().add(this);
        return this;
    }

    public Nhansu removeDetai(Detai detai) {
        this.detais.remove(detai);
        detai.getNhansus().remove(this);
        return this;
    }
